    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: auto;">
        <section class="sidebar" style="height: auto; overflow: hidden; width: auto;">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa fa-circle-o"></i> <span>Genérico</span>
                    ...
                    <ul class="treeview-menu" style="display: none;">
                        ...
                        <li><a href="#"><i class="fa fa-circle-o"></i> Orçamento</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa fa-circle-o"></i> <span>Multilevel</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                ...
                <li><a href="documentation/index.html"><i class="fa fa-circle-o"></i> <span>Documentation</span></a></li>
        ...
        <div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.2); width: 3px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: auto;"></div>
