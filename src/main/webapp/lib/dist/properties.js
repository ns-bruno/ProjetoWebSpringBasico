...
/******/ 	return __webpack_require__(__webpack_require__.s = "../webapp/WEB-INF/pages/properties/properties.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "../webapp/WEB-INF/pages/properties/properties.js":
/*!********************************************************!*\
  !*** ../webapp/WEB-INF/pages/properties/properties.js ***!
  \********************************************************/
/*! no exports provided */
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! axios */ "./node_modules/axios/dist/axios.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);



vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vuetify__WEBPACK_IMPORTED_MODULE_1___default.a);
var properties = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: "#properties",
  data: {
    dispositivo: null,
    drawer: null,
  ...
  methods: {
    initialize() {
      ...
      var selfVue = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('./Properties').then(function (response) {
        ...
        if (response.status === 200) {
          ...
          if (response.data.statusRetorno.codigoRetorno === 200) {
            ...
            if (response.data.object) {
              ...
              selfVue.returnWebservice.errorMsgExtra = ''; // Chaso nao tenha status no object entao pega o status padrao
            } else {
    ...
    deleteItem(item) {
      ...
      // Preserva toda a classe Veu aqui
      var selfVue = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.delete('./Properties', {
        params: {
    ...
    save() {
      // Preserva toda a classe Veu aqui
      var selfVue = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('./Properties', {}, {
        params: {
          chave: this.editedItem.chave,
          descricao: this.editedItem.descricao
        }
        ...
        if (response.status === 200) {
          ...
          if (response.data.statusRetorno.codigoRetorno === 200) {
            if (selfVue.editedIndex > -1) {
              Object.assign(selfVue.propriedades[selfVue.editedIndex], {
                chave: selfVue.editedItem.chave,
                descricao: selfVue.editedItem.descricao
              });
            } else {
              selfVue.propriedades.push({
                chave: selfVue.editedItem.chave,
