...
/******/ 	return __webpack_require__(__webpack_require__.s = "../webapp/WEB-INF/pages/encryption/encryption.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../webapp/WEB-INF/pages/encryption/encryption.js":
/*!********************************************************!*\
  !*** ../webapp/WEB-INF/pages/encryption/encryption.js ***!
  \********************************************************/
/*! no exports provided */
...
var encryption = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: "#encryption",
  data: {
    valido: false,
    texto: null,
    ...
    opcao: [{
      idOpcao: 0,
      descricao: 'Criptografar'
    }, {
      idOpcao: 1,
      descricao: 'Descriptografar'
    }]
  },
  ...
  methods: {
    executar: function () {
      ...
      this.conectWebserviceJson('./Encryption', // URL
      this.POST, // Metodo
      null, // Chave
      null, // Dados
      {
        tipo: this.selectOpcao,
        texto: this.texto,
        chave: this.chave
      }) // Parametro
      .then(retorno => {
