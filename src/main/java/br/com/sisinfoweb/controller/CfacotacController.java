...
import br.com.sisinfoweb.service.CfacotacService;
 ...
 */
@Controller
public class CfacotacController extends BaseMyController{
    
    @Autowired
    private CfacotacService cfacotacService;
    
    @RequestMapping(value = {"/Cfacotac"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfacotacService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfacotacService.findAllClient(sort, pageable);
            }
            ...
            cfacotacService.closeEntityManager();
        }
    }
}
