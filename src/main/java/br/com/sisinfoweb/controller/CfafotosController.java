 ...
 */
@Controller
public class CfafotosController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            PageBeans<CfafotosEntity> listaPage;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfafotosService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfafotosService.findAllClient(sort, pageable);
            }
