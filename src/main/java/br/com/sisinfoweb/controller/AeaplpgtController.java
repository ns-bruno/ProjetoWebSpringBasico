...
import br.com.sisinfoweb.service.AeaplpgtService;
 ...
 */
@Controller
public class AeaplpgtController extends BaseMyController{
    
    @Autowired
    private AeaplpgtService aeaplpgtService;
    
    @RequestMapping(value = {"/Aeaplpgt"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaplpgtService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaplpgtService.findAllClient(sort, pageable);
            }
            ...
            aeaplpgtService.closeEntityManager();
        }
    }
