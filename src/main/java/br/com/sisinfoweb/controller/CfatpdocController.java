...
import br.com.sisinfoweb.service.CfatpdocService;
 ...
 */
@Controller
public class CfatpdocController extends BaseMyController{
    
    @Autowired
    private CfatpdocService cfatpdocService;
    
    @RequestMapping(value = {"/Cfatpdoc"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfatpdocService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfatpdocService.findAllClient(sort, pageable);
            }
            ...
            cfatpdocService.closeEntityManager();
        }
    }    
}
