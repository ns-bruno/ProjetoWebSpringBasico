...
import br.com.sisinfoweb.service.AeaembalService;
 ...
 */
@Controller
public class AeaembalController extends BaseMyController{
    
    @Autowired
    private AeaembalService aeaembalService;
    
    @RequestMapping(value = {"/Aeaembal"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaembalService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaembalService.findAllClient(sort, pageable);
            }
            ...
            aeaembalService.closeEntityManager();
        }
    }
}
