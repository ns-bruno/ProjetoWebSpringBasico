...
import br.com.sisinfoweb.service.AealocesService;
 ...
 */
@Controller
public class AealocesController extends BaseMyController{
    
    @Autowired
    private AealocesService aealocesService;
    
    @RequestMapping(value = {"/Aealoces"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aealocesService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aealocesService.findAllClient(sort, pageable);
            }
            ...
            aealocesService.closeEntityManager();
        }
    }
}
