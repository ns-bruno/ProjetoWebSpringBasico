...
public class AeacodstController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            PageBeans<AeacodstEntity> listaPage;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeacodstService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeacodstService.findAllClient(sort, pageable);
            }
