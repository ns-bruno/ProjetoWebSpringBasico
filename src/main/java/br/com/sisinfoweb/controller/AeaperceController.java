...
import br.com.sisinfoweb.entity.AeaperceEntity;
import br.com.sisinfoweb.entity.SmadispoEntity;
import br.com.sisinfoweb.service.AeaperceService;
 ...
 */
@Controller
public class AeaperceController extends BaseMyController{
    
    @Autowired
    private AeaperceService aeaperceService;
    
    @RequestMapping(value = {"/Aeaperce"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaperceService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaperceService.findAllClient(sort, pageable);
            }
            ...
            aeaperceService.closeEntityManager();
        }
    }
