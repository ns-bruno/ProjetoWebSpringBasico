...
public class AeaconjtController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            aeaconjtService.setSmadispoEntity(smadispoEntity);
            
            PageBeans<AeaconjtEntity> listaPage = null;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaconjtService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaconjtService.findAllClient(sort, pageable);
            }
