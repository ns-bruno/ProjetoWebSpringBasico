...
import br.com.sisinfoweb.service.CfastatuService;
 ...
 */
@Controller
public class CfastatuController extends BaseMyController{
    
    @Autowired
    private CfastatuService cfastatuService;
    
    @RequestMapping(value = {"/Cfastatu"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfastatuService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfastatuService.findAllClient(sort, pageable);
            }
            ...
            cfastatuService.closeEntityManager();
        }
    }    
}
