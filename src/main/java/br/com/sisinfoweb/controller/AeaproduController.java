...
public class AeaproduController extends BaseMyController{
    ...
    @RequestMapping(value = {"/Aeaprodu"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    @Override
    ...
    @RequestMapping(value = {"/Aeaprrec"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
