...
import br.com.sisinfoweb.service.CfaprofiService;
 ...
 */
@Controller
public class CfaprofiController extends BaseMyController{
    
    @Autowired
    private CfaprofiService cfaprofiService;
    
    @RequestMapping(value = {"/Cfaprofi"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfaprofiService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfaprofiService.findAllClient(sort, pageable);
            }
            ...
            cfaprofiService.closeEntityManager();
        }
    }    
}
