...
import br.com.sisinfoweb.service.CfacidadService;
 ...
 */
@Controller
public class CfacidadController extends BaseMyController{
    
    @Autowired
    private CfacidadService cfacidadService;
    
    @RequestMapping(value = {"/Cfacidad"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfacidadService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfacidadService.findAllClient(sort, pageable);
            }
            ...
            cfacidadService.closeEntityManager();
        }
    }
