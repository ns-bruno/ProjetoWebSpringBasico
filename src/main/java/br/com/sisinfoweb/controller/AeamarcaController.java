...
import br.com.sisinfoweb.service.AeamarcaService;
 ...
 */
@Controller
public class AeamarcaController extends BaseMyController{
    
    @Autowired
    private AeamarcaService aeamarcaService;
    
    @RequestMapping(value = {"/Aeamarca"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeamarcaService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeamarcaService.findAllClient(sort, pageable);
            }
            ...
            aeamarcaService.closeEntityManager();
        }
    }
