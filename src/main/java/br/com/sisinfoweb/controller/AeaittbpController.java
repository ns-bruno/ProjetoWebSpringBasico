...
import br.com.sisinfoweb.service.AeaittbpService;
 ...
 */
@Controller
public class AeaittbpController extends BaseMyController{
    
    @Autowired
    private AeaittbpService aeaittbpService;
    
    @RequestMapping(value = {"/Aeaittbp"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            aeaittbpService.setSmadispoEntity(smadispoEntity);
            
            PageBeans<AeaittbpEntity> listaPage = null;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaittbpService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaittbpService.findAllClient(sort, pageable);
            }
