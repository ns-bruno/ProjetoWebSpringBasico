...
import br.com.sisinfoweb.entity.AeaplojaEntity;
import br.com.sisinfoweb.entity.SmadispoEntity;
import br.com.sisinfoweb.service.AeaplojaService;
 ...
 */
@Controller
public class AeaplojaController extends BaseMyController{
    
    @Autowired
    private AeaplojaService aeaplojaService;
    
    @RequestMapping(value = {"/Aeaploja"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaplojaService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaplojaService.findAllClient(sort, pageable);
            }
            ...
            aeaplojaService.closeEntityManager();
        }
    }
