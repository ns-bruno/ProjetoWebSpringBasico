...
import br.com.sisinfoweb.entity.AeatbproEntity;
import br.com.sisinfoweb.entity.SmadispoEntity;
import br.com.sisinfoweb.service.AeatbproService;
 ...
 */
@Controller
public class AeatbproController extends BaseMyController{
    
    @Autowired
    private AeatbproService aeatbproService;
    
    @RequestMapping(value = {"/Aeatbpro"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            aeatbproService.setSmadispoEntity(smadispoEntity);
            
            PageBeans<AeatbproEntity> listaPage = null;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeatbproService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeatbproService.findAllClient(sort, pageable);
            }
