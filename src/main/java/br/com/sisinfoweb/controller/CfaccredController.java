...
import br.com.sisinfoweb.entity.CfaccredEntity;
import br.com.sisinfoweb.entity.SmadispoEntity;
import br.com.sisinfoweb.service.CfaccredService;
 ...
 */
@Controller
public class CfaccredController extends BaseMyController{
    
    @Autowired
    private CfaccredService cfaccredService;
    
    @RequestMapping(value = {"/Cfaccred"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfaccredService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfaccredService.findAllClient(sort, pageable);
            }
            ...
            cfaccredService.closeEntityManager();
        }
    }
