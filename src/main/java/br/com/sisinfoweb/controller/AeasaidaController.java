...
public class AeasaidaController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            PageBeans<AeasaidaEntity> listaPage;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeasaidaService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeasaidaService.findAllClient(sort, pageable);
            }
