...
import br.com.sisinfoweb.service.AeagradeService;
 ...
 */
@Controller
public class AeagradeController extends BaseMyController{
    
    @Autowired
    private AeagradeService aeagradeService;
    
    @RequestMapping(value = {"/Aeagrade"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeagradeService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeagradeService.findAllClient(sort, pageable);
            }
            ...
            aeagradeService.closeEntityManager();
        }
    }
