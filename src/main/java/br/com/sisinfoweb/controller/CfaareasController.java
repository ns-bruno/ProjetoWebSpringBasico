...
public class CfaareasController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            PageBeans<CfaareasEntity> listaPage;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfaareasService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfaareasService.findAllClient(sort, pageable);
            }
