 ...
 */
@Controller
public class AeaclaseController extends BaseMyController{
    
    @Autowired
    private AeaclaseService aeaclaseService;
    
    @RequestMapping(value = {"/Aeaclase"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            PageBeans<AeaclaseEntity> listaPage = null;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaclaseService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaclaseService.findAllClient(sort, pageable);
            }
