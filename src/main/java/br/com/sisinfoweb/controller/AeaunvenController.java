...
import br.com.sisinfoweb.service.AeaunvenService;
 ...
 */
@Controller
public class AeaunvenController extends BaseMyController{
    
    @Autowired
    private AeaunvenService aeaunvenService;
    
    @RequestMapping(value = {"/Aeaunven"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaunvenService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaunvenService.findAllClient(sort, pageable);
            }
            ...
            aeaunvenService.closeEntityManager();
        }
    }
