...
import br.com.sisinfoweb.service.CfatpcliService;
 ...
 */
@Controller
public class CfatpcliController extends BaseMyController{
    
    @Autowired
    private CfatpcliService cfatpcliService;
    
    @RequestMapping(value = {"/Cfatpcli"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfatpcliService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfatpcliService.findAllClient(sort, pageable);
            }
            ...
            cfatpcliService.closeEntityManager();
        }
    }    
}
