...
import br.com.sisinfoweb.service.AeaprecoService;
 ...
 */
@Controller
public class AeaprecoController extends BaseMyController{
    
    @Autowired
    private AeaprecoService aeaprecoService;
    
    @RequestMapping(value = {"/Aeapreco"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaprecoService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaprecoService.findAllClient(sort, pageable);
            }
            ...
            aeaprecoService.closeEntityManager();
        }
    }
