...
public class CfaativiController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            PageBeans<CfaativiEntity> listaPage;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfaativiService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfaativiService.findAllClient(sort, pageable);
            }
