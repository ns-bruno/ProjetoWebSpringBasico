...
public class CfaativiController extends BaseMyController{
    ...
    @RequestMapping(value = {"/Cfaativi"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                lista = cfaativiService.findCustomNativeQuery(resume, sqlQuery, columnSelected, where);
            
            } else {
                lista = cfaativiService.findAll();
            }
