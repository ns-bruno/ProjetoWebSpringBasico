...
import br.com.sisinfoweb.entity.CfaparamEntity;
import br.com.sisinfoweb.entity.SmadispoEntity;
import br.com.sisinfoweb.service.CfaparamService;
 ...
 */
@Controller
public class CfaparamController extends BaseMyController{
    
    @Autowired
    private CfaparamService cfaparamService;
    
    @RequestMapping(value = {"/Cfaparam"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = cfaparamService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = cfaparamService.findAllClient(sort, pageable);
            }
            ...
            cfaparamService.closeEntityManager();
        }
    }
