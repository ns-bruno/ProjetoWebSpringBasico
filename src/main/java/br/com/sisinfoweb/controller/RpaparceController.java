...
import br.com.sisinfoweb.service.RpaparceService;
 ...
 */
@Controller
public class RpaparceController extends BaseMyController{
    
    @Autowired
    private RpaparceService rpaparceService;
    
    @RequestMapping(value = {"/Rpaparce"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                lista = rpaparceService.findCustomNativeQuery(resume, sqlQuery, columnSelected, where);
            
            } else {
                lista = rpaparceService.findAll();
            }
