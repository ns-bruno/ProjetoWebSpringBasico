...
import br.com.sisinfoweb.service.AeaemtbpService;
 ...
 */
@Controller
public class AeaemtbpController extends BaseMyController{
    ...
    public String initJson( Model model, 
        ...
        try{
            ...
            aeaemtbpService.setSmadispoEntity(smadispoEntity);
            
            PageBeans<AeaemtbpEntity> listaPage = null;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeaemtbpService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeaemtbpService.findAllClient(sort, pageable);
            }
