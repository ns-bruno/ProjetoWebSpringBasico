...
import br.com.sisinfoweb.entity.AeafatorEntity;
import br.com.sisinfoweb.entity.SmadispoEntity;
import br.com.sisinfoweb.service.AeafatorService;
 ...
 */
@Controller
public class AeafatorController extends BaseMyController{
    
    @Autowired
    private AeafatorService aeafatorService;
    
    @RequestMapping(value = {"/Aeafator"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = aeafatorService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = aeafatorService.findAllClient(sort, pageable);
            }
            ...
            aeafatorService.closeEntityManager();
        }
    }
