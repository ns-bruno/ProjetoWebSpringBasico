...
public class CfatpcobController extends BaseMyController{
    ...
    @RequestMapping(value = {"/Cfatpcob"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                lista = cfatpcobService.findCustomNativeQuery(resume, sqlQuery, columnSelected, where);
            
            } else {
                lista = cfatpcobService.findAll();
            }
