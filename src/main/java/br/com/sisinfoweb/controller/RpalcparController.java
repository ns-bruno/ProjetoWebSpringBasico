 ...
 */
@Controller
public class RpalcparController extends BaseMyController{
    
    @Autowired
    RpalcparService rpalcparService;
    
    @RequestMapping(value = {"/Rpalcpar"}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    @ResponseBody
    @Override
    public String initJson( Model model, 
        ...
        try{
            ...
            rpalcparService.setSmadispoEntity(smadispoEntity);
            
            PageBeans<RpalcparEntity> listaPage = null;
            ...
            if ( ((sqlQuery != null) && (!sqlQuery.isEmpty())) || 
                ...
                listaPage = rpalcparService.findCustomNativeQueryClient(resume, sqlQuery, columnSelected, where, sort, pageable);
            
            } else {
                listaPage = rpalcparService.findAllClient(sort, pageable);
            }
